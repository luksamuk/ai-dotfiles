...
case "${1:-qwen3.5-4b}" in
  ...
  *)
    ...
    echo "Available: qwen3.5-0.8b, qwen3.5-4b, qwen3.5-9b, gemma4-e4b, gemma4-e2b, lfm2.5-vl-450m, lfm2.5-8b-a1b, qwen3.6-35b-a3b, ornith-1.0-35b, agents-a1-35b, qwopus-35b, gpt-oss-20b, ornstein-36-35b, minicpm5-1b, all"
    exit 1
    ;;
esac
