...
#   qwen2.5-coder-1.5b-pollard - Qwen2.5-Coder-1.5B-Instruct Pollard IQ4_XS (~824 MB) - FIM, imatrix, CPU-only
#   qwen3.8-27b-pollard - Qwen3.8-27B Pollard IQ3_S (~12 GB) + mmproj bf16 - dense VLM DeltaNet
...
declare -A MODELS=(
  ...
  # Pollard Coder IQ4_XS with imatrix (FIM, CPU-only, coexists with GPU MoE)
  ["qwen2.5-coder-1.5b-pollard"]="PollardWeights/Qwen2.5-Coder-1.5B-Instruct-Pollard Qwen2.5-Coder-1.5B-Instruct-Pollard-IQ4_XS.gguf"
  # Pollard Qwen3.8-27B IQ3_S — dense VLM DeltaNet, exact imatrix, from Q8_0 source (~12 GB)
...
# Format: "repo filename [local_filename]"
declare -A MMPROJ=(
  ["qwen3.8-27b-pollard"]="PollardWeights/Qwen3.8-27B-Pollard mmproj-Qwen3.8-27B-bf16.gguf"
...
download_model() {
  ...
  if [[ -z "$repo_file" ]]; then
    ...
    echo "Available: qwen3.5-4b, qwen3.5-9b, nanbeige4.2-3b, gemma4-e4b, gemma4-e2b, lfm2.5-vl-450m, lfm2.5-vl-1.6b-extract, lfm2.5-8b-a1b, lfm2.5-2.6b, qwen2.5-coder-1.5b-pollard, qwen3.8-27b-pollard, qwen3.6-35b-a3b, ornith-1.0-35b, kat-coder-v2.5-dev, agentworld-35b, agents-a1-35b, glm-4.7-flash, athenas-symbiote-9b, qwopus-35b, gpt-oss-20b, minicpm-v-4.6, qwen3-vl-4b, smolvlm2-500m-video, minicpm5-1b-agentic, smolllm3-3b, webworld-8b, qwopus-coder-9b, hy-mt2-1.8b, qwen3.5-4b-abliterated, glm-ocr, nomic-embed-text-v2-moe, nemotron-3-embed-1b, mellum2-12b-thinking, ornstein-36-35b, all"
    return 1
  fi
...
#   [REMOVED] gemma4-e2b (PTQ) — superseded by QAT, Jun 2026
  ...
  echo "  qwen3.8-27b-pollard   ~12.08 GB (Pollard IQ3_S) + 0.93 GB mmproj - Dense VLM DeltaNet, imatrix, 262K ctx"
